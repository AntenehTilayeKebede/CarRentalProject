...
<html lang="en">
  ...
  <body>
    <div class="header max-w-[1920px] snipcss-q5WLJ">
      <a href="/">
    ...
    <div class="hero-content snipcss-P3VVJ">
      <div class="hero-text">
        ...
        <p>
          Experience your dream car rental with unbeatable prices, unlimited
          mileage, flexible pick-up choices, and additional benefits.
        </p>
        <div class="hero-btns">
          <button class="hero-btn book-btn" id="bookRide">
            Book Ride
           
            </svg>
          </button>
          <button class="hero-btn learn-btn" id="learnmore" >
            Learn More
      ...
      <img src="images\homepage_car.png" class="hero-img" />
    </div>
    <div class="section max-w-[1920px] snipcss-dYExF">
      <h4>Plan your trip now</h4>
      <h1 class="h1">Quick &amp; easy car rental</h1>
      <div class="Intro-boxes">
        ...
        <div class="Intro-box">
          ...
          <p>
            ...
            wide range of cars. No time!
          </p>
        </div>
      </div>
    </div>
    <div class="footer-section snipcss-hGlNw">
    ...
    <script src="redirect.js" async defer></script>
