...
<html lang="en">
  ...
  <body>
    <div class="header max-w-[1920px] snipcss-oKCsh">
      <a href="/">
      ...
      <ul class="Nav-menu">
        ...
        <div class="nav-btns">
          <button class="nav-btn sign-in">Log in In</button>
          <button class="nav-btn register">Register</button>
        </div>
      </ul>
      <div class="openNav">
        <svg
    ...
    <div class="heroimage-sec snipcss-TEjSK">
      <div class="heroimage-con">
    ...
    <div class="chooseUs-section snipcss-dBP7j">
      <div class="wcu-container">
        <div class="choose-us-image">
          <img
            src="https://carsrental.vercel.app/static/media/lg.70cd75042bdf42515d92.png"
          />
        </div>
        <div class="wcu-flex">
          <div class="left">
            ...
            <button class="wcu-btn">
              <a href="find.php">Find Details</a>
    ...
    <div class="footer-section snipcss-hGlNw snipcss-5Kps4">
